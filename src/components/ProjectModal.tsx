        ...
        <>
          ...
          >
            ...
            <motion.div
              ...
              className="bg-gray-900 rounded-lg shadow-2xl border border-gray-800 max-w-lg w-full max-h-[90vh] overflow-hidden z-50"
                  ...
                  {project.link && (
                    <div>
                      ...
                      <a
                        ...
                        className="inline-flex items-center gap-2 text-accent-400 hover:text-blue-300 transition-colors duration-200"
                      >
